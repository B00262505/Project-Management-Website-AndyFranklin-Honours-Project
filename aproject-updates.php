...
<head>
    ...
    <script src="js/aproject-updates.js"></script>
    ...
    <div class="row fluid-content-aproject">
        <div class="col-md-3 sidebar">
            <ul>
                ...
                <li class="project-active-sidebar sidebar-menu-1"><a href=""  class="sidebar-menu-1">Recent Updates<span class="glyphicon glyphicon-time pull-right"></span></a></li>
        ...
        <div class="col-md-9 col-md-offset-3 project-area">
            <div class="panel panel-default">
                <div class="panel-heading blue-bg">
                    <h3 class="panel-title"><b>Project Log</b></h3>
                </div>
