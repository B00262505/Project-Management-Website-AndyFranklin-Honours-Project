...
<div class="container-fluid">
    ...
    <div class="row fluid-content-aproject">
        <div class="col-md-3 sidebar">
            <ul>
                <li class="project-active-sidebar" class="sidebar-menu-1">Overview<span class="glyphicon glyphicon-home pull-right"></span></a></li>
        ...
        <div class="col-md-9 col-md-offset-3 project-area">
            ...
            <div class="panel panel-default">
                <div class="panel-heading blue-bg">
                    <h3 class="panel-title" id="current-project-title"></h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <p id="current-project-dates" class="current-project-description"></p>
                        <p id="current-project-description" class="current-project-description"></p>
                    </div>
                </div>
            </div>
        </div>
